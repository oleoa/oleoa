...
export function Piece({ team, piece }: { team: TeamType; piece: PieceName }) {
  return (
    <>
      {piece == "pawn" && <PawnSvg team={team} />}
      {piece == "rook" && <RookSvg team={team} />}
      {piece == "bishop" && <BishopSvg team={team} />}
      {piece == "knight" && <KnightSvg team={team} />}
      {piece == "queen" && <QueenSvg team={team} />}
      {piece == "king" && <KingSvg team={team} />}
    </>
  );
}

function PawnSvg({ team }: { team: TeamType }) {
  return (
    <svg
...
function RookSvg({ team }: { team: TeamType }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
...
function BishopSvg({ team }: { team: TeamType }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 320 512"
...
function KnightSvg({ team }: { team: TeamType }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
...
function QueenSvg({ team }: { team: TeamType }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
...
function KingSvg({ team }: { team: TeamType }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
